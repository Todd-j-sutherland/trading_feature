...
class IGMarketsPaperTrader:
    ...
    def _check_exit_conditions(self, trade: PaperTrade, current_price: float) -> Dict:
        ...
        try:
            ...
            # Create position data for exit strategy evaluation
            position_data = {
                'symbol': trade.symbol,
            ...
            exit_conditions = engine.check_exit_conditions(position_data)
    ...
    def process_new_predictions(self) -> List[PaperTrade]:
        ...
        # Get recent predictions that haven't been traded yet
        ...
        cursor.execute("""
            ...
            LEFT JOIN (SELECT DISTINCT prediction_id FROM paper_trades) pt 
            ON p.prediction_id = pt.prediction_id
