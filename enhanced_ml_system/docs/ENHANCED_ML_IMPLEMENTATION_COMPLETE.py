...
def main():
    ...
    print("   • Run: python enhanced_ml_system/testing/enhanced_ml_test_integration.py (for testing)")
    print("   • Run: python enhanced_ml_system/integration/test_app_main_integration.py (for integration testing)")
    print("   • Run: python run_enhanced_ml_tests.py (for complete test suite)")
