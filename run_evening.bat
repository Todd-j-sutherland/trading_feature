@echo off
echo Running Trading System Evening Routine...
...
"c:\Users\todd.sutherland\trading_feature\trading_venv\bin\python.exe" -m app.main evening 2>nul && goto :success

echo Trying system python...
python -m app.main evening 2>nul && goto :success

echo Trying python3...
python3 -m app.main evening 2>nul && goto :success

echo Trying py launcher...
py -m app.main evening 2>nul && goto :success
...
echo python -m app.main evening
pause
goto :end

:success
echo ✅ Evening routine completed successfully!
pause
